  ...
  outputs = { self, nixpkgs, flake-utils }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        my-charset-normalizer = with pkgs.python3Packages;
          toPythonModule (pkgs.python3Packages.charset-normalizer.overrideAttrs
            (old: rec {
              version = "3.1.0";
        ...
        my-requests = with pkgs.python3Packages;
          toPythonModule (pkgs.python3Packages.requests.override {
        ...
        htmldate = with pkgs.python3Packages;
          buildPythonPackage {
            ...
            propagatedBuildInputs =
              [ my-charset-normalizer python-dateutil dateparser lxml urllib3 ];
            doCheck = false;
          };
        ...
        youtube-transcript-api = with pkgs.python3Packages;
          buildPythonPackage {
        ...
        pythonEnv = pkgs.python3.withPackages
          (ps: [ trafilatura youtube-transcript-api ]);
      in {
        # packages.x86_64-linux.default = self.packages.x86_64-linux.hello;
        devShell = with pkgs;
          pkgs.mkShell {
            buildInputs = [ liquibase openjdk21 ];
            packages = [ pythonEnv ];
          };
